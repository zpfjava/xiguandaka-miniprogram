...
Page({
  data: {
    faqs: [
      ...
      { question: '星星怎么获得？怎么使用？', answer: '获得方式：每次打卡 +5⭐、每日签到 +3⭐、连续打卡额外奖励 +2~10⭐、解锁成就 +10~50⭐。使用方式：在"愿望清单"中添加你想要的奖励，存够星星后即可兑换！', expanded: false },
    ...
    guides: [
      { step: 1, title: '创建学习计划', desc: '点击底部"计划"，添加你想养成的学习习惯' },
      { step: 2, title: '每天完成打卡', desc: '在首页查看今日任务，完成后点击"去打卡"' },
      { step: 3, title: '积累星星奖励', desc: '每次打卡和签到都能获得星星，攒够了兑换心愿' },
      { step: 4, title: '见证成长变化', desc: '观察苗苗的成长阶段，查看统计和排行榜' }
    ],
